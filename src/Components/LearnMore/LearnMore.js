  ...
  return (
    <Col className="mx-auto " id="learnmore" lg={11} xl={10} xxl={7}>
      <Wrapper>
        ...
        <iframe width="560" height="315" position="center" src="https://www.youtube.com/embed/d5Y2YgvRVkQ?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        Each world is 16,000,000 x 16,000,000 blocks in size and accessible from your Plot via a "Portal" directly 
        giving you nearly infinite space to start building your community and develop your metaverse where your plot act has a Lobby.
        </h1>
